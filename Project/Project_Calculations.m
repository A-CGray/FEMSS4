...
%     xlabel('X (m)', 'FontSize', 14), grid on
%     title([beam_size{beam}, ' Beam, Theoretical Bending Stress and Deflection'], 'FontSize', 16)
%     savefig(['images\', beam_size{beam}, ' Beam, Theoretical Bending Stress and Deflection.fig'])
%     print(['images\', beam_size{beam}, ' Beam, Theoretical Bending Stress and Deflection.png'], '-dpng')
end
...
%         end
%         legend('Euler', 'Timoshenko', '2 Elements', '10 Elements', 'Location', 'best')
